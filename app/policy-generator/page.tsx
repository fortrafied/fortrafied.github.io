...
export const metadata: Metadata = { title: 'DLP Policy Generator' };

export default function PolicyGeneratorPage() {
  return (
    <>
      <PageHeader
        title="DLP Policy Generator"
        description="Generate starter DLP policy configurations and templates for common platforms."
      />
